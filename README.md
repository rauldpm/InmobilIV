...
- Rúbrica 2: Dockerfile correcto, explicación de cada parte del dockerfile
  ...
  - Ejecutando la orden: **docker build -t="rauldpm/inmobiliv" .** se puede observar que no ha habido ningún error en la ejecución, por lo que el fichero Dockerfile no contiene errores:
  
![Build](docs/img/DockerHub/dockerhub_build.png)
